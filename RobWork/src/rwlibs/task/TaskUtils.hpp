...
namespace rwlibs { namespace task {
    ...
    class TaskUtils
    {
      public:
         ...
         *
         * The first template argument T specifies the type of task, e.g. rw::math::Q or
         * rw::math::Transform3D. The second template argument M specifies which type of motion,
         * e.g. P2PMotion or LinearMotion. It is required that the motion M has a constructor taking

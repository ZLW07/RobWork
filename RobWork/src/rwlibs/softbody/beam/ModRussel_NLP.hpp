...
namespace rwlibs { namespace softbody {
    ...
    class ModRussel_NLP : public Ipopt::TNLP
    {
      ...
      private:
        void eval_g_point (int pIdx, int gBase, Ipopt::Index n, const Ipopt::Number* x, bool new_x,
                           Ipopt::Index m, Ipopt::Number* g);
        void eval_jac_g_point (int pIdx, int gBase, Ipopt::Index n, const Ipopt::Number* x,
      ...
      public:
         ...
         *
         * returns the total elastic energy for the last solution. The energy returned is in units
         *of [kg mm^ 2 / s^2]
         *
      ...
      private:
        ...
        std::vector< int >
            _integralIndices;    // vector of indices at which to check for penetration

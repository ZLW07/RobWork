...
namespace rwlibs { namespace softbody {
    ...
    class BeamGeometry
    {
      public:
         ...
         *
         * @note For a Mod Russel beam in a typical coordinate frame, the vector of gravitiy \em G
         * should be defined as to make the gravitational potential energy \em increase for
         * increased values of y, e.g. \f$ G=(0.0, 9.82, 0.0) \f$
         *
         * @param L length of object
         * @param Exvec vector of Young's modulus for each cross beam cros section, in MPa
         * @param vxvec vector of Poisson's ratio for each cross beam cros section
      ...
      public:
         ...
         *
         * Kappa is the coefficient relating the i,k = (1,1) coefficients of strain to stress in a
         *plane stress situation, i.e.
         *
         * \f[
         *  \sigma_{11} = \frac{E}{1 - \nu^2} u_{11}
         * \f]
        ...
        /**
         * @brief returns the x-component of vector of gravity for the current configuration of the
         *beam
         *

    ...
    */
    class SBLOptions
    {
      public:
        ...
        //! @brief Attempt connection of the trees if the distance to the nearest neighbor is below
        //! this threshold.
        ...
        enum TreeSelection {
            ...
            WeightedTree,    //!< choose the tree randomly, but weighted according to the size of
                             //!< the tree.

...
void DrawableUtil::transform3DToGLTransform (const rw::math::Transform3D< float >& transform,
                                             GLfloat* gltrans)
{
    for (int j = 0; j < 3; j++) {
        for (int k = 0; k < 3; k++)
...
void DrawableUtil::transform3DToGLTransform (const rw::math::Transform3D< double >& transform,
                                             GLfloat* gltrans)
{
    for (int j = 0; j < 3; j++) {
        for (int k = 0; k < 3; k++)

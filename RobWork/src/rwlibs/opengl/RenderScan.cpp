...
RenderScan::RenderScan (const rw::geometry::PointCloud& img) : _minDepth (0), _maxDepth (10)
{
    setScan (img);
}

RenderScan::RenderScan () : _minDepth (0), _maxDepth (10)
{}
...
void RenderScan::draw (const DrawableNode::RenderInfo& info, DrawableNode::DrawType type,
                       double alpha) const
{

...
namespace rwlibs { namespace proximitystrategies {
     ...
     */
    class ProximityStrategyPQP : public rw::proximity::CollisionStrategy,
                                 ...
                                 public rw::proximity::DistanceMultiStrategy
    {
      public:
        ...
        {
            PQPProximityModel (ProximityStrategy* owner) : ProximityModel (owner) {}
    ...
    // static const bool PQPCollisionStrategyRegistrered =
    // rw::proximity::ProximityStrategyFactory::addCollisionStrategy<ProximityStrategyPQP>("PQP");
    // static const bool PQPDistanceStrategyRegistrered =
    // rw::proximity::ProximityStrategyFactory::addDistanceStrategy<ProximityStrategyPQP>("PQP");

...
namespace rwlibs { namespace assembly {
     ...
     *
     * \image html assembly/PiHStrategy.png "The insertion strategy with parameters shown. Left
     * image shows the initial approach pose, second image shows the linear approach motion, third
     * image shows the angular motion, and the right image shows the final linear insertion."
     *
     ...
     * Online Action Learning using Kernel Density Estimation for Quick Discovery of Good Parameters
     * for Peg-in-Hole Insertion, In Proceedings of the 13th International Conference on Informatics
     * in Control, Automation and Robotics (ICINCO 2016), Volume 2, pages 166-177
     */
    class PiHStrategy : public AssemblyControlStrategy
    {
      public:
         ...
         * @brief Constructor.
         *
         * This strategy generates trajectories in world coordinates, assuming the hole body is
         * stationary. Hence it must be given the transform of the hole body.
         *
         * @param worldTfemale [in] the transform of the hole body.
         * @param femaleTfemaleTcp [in] (optional) if the hole body frame does is not at the top of
         * the hole, the transform from the body frame to the top of the hole should be given here.
         * @param maleTmaleTcp [in] (optional) if the peg body frame does is not at the end of the

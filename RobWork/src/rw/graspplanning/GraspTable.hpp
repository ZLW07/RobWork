...
namespace rw { namespace graspplanning {
    ...
    class GraspTable
    {
      ...
      public:
        ...
        // std::vector<GraspData> findGrasps(const rw::math::Vector3D<>& approach, double
        // maxAngle,GraspValidateFilter* filter = NULL); std::vector<GraspData>
        // findGrasps(rw::math::Q& minQ, const rw::math::Vector3D<>& approach, double
        // maxAngle,GraspValidateFilter* filter = NULL);

...
PrismaticSphericalJoint::PrismaticSphericalJoint (const std::string& name,
...
void PrismaticSphericalJoint::doMultiplyTransform (const Transform3D<>& parent, const State& state,
...
void PrismaticSphericalJoint::getJacobian (std::size_t row, std::size_t col,

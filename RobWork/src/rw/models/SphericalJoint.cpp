...
SphericalJoint::SphericalJoint (const std::string& name, const Transform3D<>& transform) :
    Joint (name, 3), _T (transform)
{}

SphericalJoint::~SphericalJoint ()
{}

void SphericalJoint::doMultiplyTransform (const Transform3D<>& parent, const State& state,
...
void SphericalJoint::getJacobian (std::size_t row, std::size_t col, const Transform3D<>& joint,

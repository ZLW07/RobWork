...
namespace rw { namespace graphics {
    ...
    class DrawableNodeClone : public DrawableNode
    {
      public:
         ...
         * @param drawable [in] the drawable to clone - it will not make an actual clone of data,
         * only of the visualization.
         */
        DrawableNodeClone (const std::string& name, DrawableNode::Ptr drawable) :
            DrawableNode (name), _drawable (drawable)
        {
      ...
      private:
        ...
        mutable bool _highlightedState, _highlighted, _visibleState, _visible;

...
namespace rw { namespace graphics {
    ...
    class SceneCamera : public SceneNode
    {
      public:
        ...
        typedef enum {
            Auto,      //!< The aspect is automatically adjusted to fit entire viewport
            Scale,     //!< the aspect ratio is fixed and the scaling is performed such that the
                       //!< largest picure is obtained

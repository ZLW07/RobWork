...
namespace rw { namespace loaders {
    ...
    class DOMTrajectorySaver
    {
      public:
         ...
         *
         * If the DOMTrajectorySaver is used outside main (as a part of global
         ...
         * should not be necessary to specify the initializer explicitly if DOMTrajectorySaver is to

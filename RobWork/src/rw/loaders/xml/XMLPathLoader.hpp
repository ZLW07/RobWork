...
namespace rw { namespace loaders {
     ...
     *
     * The XMLPathLoader loads in a file containing a path specified according to the rwxml_path.xsd
     ...
     * determined using the XMLPathLoader::getType after loading.
     *
    ...
    class XMLPathLoader
    {
      public:
         ...
         *
         * If the XMLPathLoader is used outside main (as a part of global
         ...
         * should not be necessary to specify the initializer explicitly if XMLPathLoader is to be

...
namespace rw { namespace loaders {
    ...
    class XMLPropertySaver
    {
      public:
         ...
         *
         * Constructs a new DOMElement for the document \b doc and adds the properties in \b map to
         * it.
         *
         ...
         *
         * If the XMLPropertySaver is used outside main (as a part of global
         ...
         * should not be necessary to specify the initializer explicitly if XMLPropertySaver is to

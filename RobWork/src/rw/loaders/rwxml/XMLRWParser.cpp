...
struct Transform3DParser
    : public grammar< Transform3DParser, result_closure< Transform3D<> >::context_t >
{
  public:
    template< typename ScannerT > struct definition
    {
      public:
        ...
        {
            transform_r = (matrix_transform_r | rpypos_transform_r);

            rpy_r =
                XMLElem_p ("RPY",
                           real_p[var (_rpy (0)) = arg1 * Deg2Rad] >>
                               real_p[var (_rpy (1)) = arg1 * Deg2Rad] >>
                               real_p[var (_rpy (2)) = arg1 * Deg2Rad][rpy_r.result_ = var (_rpy)]);

            pos_r = XMLElem_p ("Pos",
                               real_p[var (_pos (0)) = arg1] >> real_p[var (_pos (1)) = arg1] >>
                                   real_p[var (_pos (2)) = arg1][pos_r.result_ = var (_pos)]);

            rpypos_transform_r =
                ((rpy_r[var (_rpy) = arg1] >>
                  pos_r[var (_pos) = arg1])[self.result_ = construct_< Transform3D<> > (
                                                var (_pos), var (_rpy))]) |
                ((pos_r[var (_pos) = arg1] >>
                  rpy_r[var (_rpy) = arg1])[self.result_ = construct_< Transform3D<> > (
                                                var (_pos), var (_rpy))])
...
struct QuotedStringParser
    : public grammar< QuotedStringParser, result_closure< std::string >::context_t >
{
  public:
    template< typename ScannerT > struct definition
    {
...
struct XMLAttrStringParser
    : public grammar< XMLAttrStringParser, result_closure< std::string >::context_t >
{
  public:
    template< typename ScannerT > struct definition
    {
      public:
        ...
        {
            attrstr_r = (*(anychar_p - '"'))[self.result_ = construct_< std::string > (arg1, arg2)];
        }
  ...
  public:
    template< typename ScannerT > struct definition
    {
      public:
        ...
        {
            property_r = XMLAttElem_p (
                "Property",
                XMLAtt_p ("name", attrstr_p[var (_property._name) = arg1]) >>
                    !(XMLAtt_p ("type", attrstr_p[var (_property._type) = arg1])) >>
                    !(XMLAtt_p ("refframe", attrstr_p[var (_property._refframe) = arg1])) >>
                    !(XMLAtt_p ("desc", attrstr_p[var (_property._desc) = arg1])),
                (*(anychar_p -
                   (str_p ("</") >>
                    "Property")))[var (_property._val) = construct_< std::string > (arg1, arg2)]
  ...
  public:
    ...
    template< typename ScannerT > struct definition
    {
      public:
        ...
        {
            model_r =
                eps_p[var (_model) = construct_< DummyModel > ()] >>
                (drawable_r |
                 colmodel_r)[var (_model._scope) = var (self._scope)][self.result_ = var (_model)];

            colmodel_r =    // eps_p[ var( _model ) = colmodel_r.result_ ] >> // used to initialize
                            // _model
                (XMLAttElem_p (
                    "CollisionModel",
                    ...
                    !transform3d_p[var (_model._transform) = arg1] >>
                        ...
                        *(geometry_r[push_back_a (_model._geo)])))[var (_model._isDrawable) =
                                                                       false];

            drawable_r = (XMLAttElem_p (
                "Drawable",
                (XMLAtt_p ("name", attrstr_p[var (_model._name) = arg1])) >>
                    !(XMLAtt_p ("refframe", attrstr_p[var (_model._refframe) = arg1])) >>
                    !(XMLAtt_p ("colmodel",
                                (str_p ("Enabled")[var (_model._colmodel) = true] |
                                 str_p ("Disabled")[var (_model._colmodel) =
                                                        false]))),    // used to initialize _model
                !transform3d_p[var (_model._transform) = arg1] >> *(rgb_r) >>
                    *(geometry_r[push_back_a (_model._geo)])))[var (_model._isDrawable) = true];

            rgb_r = XMLElem_p (
                "RGB",
                real_p[var (_model._r) = arg1] >> real_p[var (_model._g) = arg1] >>
                    real_p[var (_model._b) = arg1] >>
                    *real_p[var (_model._a) = arg1][var (_model._customMaterial) = true]);

            geometry_r =
                eps_p[var (_geo) = construct_< DummyGeometry > ()] >>
                (XMLAttElem_p (
                     "Polytope",
                     XMLAtt_p (
                         "file",
                 ...
                 XMLAttElem_p (
                     "Sphere",
                     XMLAtt_p ("radius",
                               real_p[var (_geo._radius) = arg1][var (_geo._type) = SphereType]) >>
                 ...
                 XMLAttElem_p (
                     ...
                     XMLAtt_p ("x", real_p[var (_geo._x) = arg1]) >>
                         ...
                         XMLAtt_p ("z", real_p[var (_geo._z) = arg1][var (_geo._type) = CubeType]),
                     eps_p) |
                 XMLAttElem_p (
                     "Cone",
                     XMLAtt_p ("radius", real_p[var (_geo._radius) = arg1]) >>
                         XMLAtt_p ("z",
                                   real_p[var (_geo._z) = arg1][var (_geo._type) = ConeType]) >>
                         *XMLAtt_p ("level", real_p[var (_geo._level) = arg1]),
                     eps_p) |
                 XMLAttElem_p (
                     "Cylinder",
                     XMLAtt_p ("radius", real_p[var (_geo._radius) = arg1]) >>
                         XMLAtt_p ("z",
                                   real_p[var (_geo._z) = arg1][var (_geo._type) = CylinderType]) >>
                         *XMLAtt_p ("level", real_p[var (_geo._level) = arg1]),
                     eps_p) |
                 XMLAttElem_p (
                     "Tube",
                     XMLAtt_p ("radius", real_p[var (_geo._radius) = arg1]) >>
                         ...
                         XMLAtt_p ("z",
                                   real_p[var (_geo._z) = arg1][var (_geo._type) = TubeType]) >>
                         *XMLAtt_p ("level", real_p[var (_geo._level) = arg1]),
                     eps_p) |
                 XMLAttElem_p (
                     "Custom",
                     XMLAtt_p (
                         "type",
                         attrstr_p[var (_geo._filename) = arg1][var (_geo._type) = CustomType]) >>
                         XMLAtt_p ("param", attrstr_p[var (_geo._parameters) = arg1]),
                     eps_p))[geometry_r.result_ = var (_geo)];
        }
...
struct RigidBodyParser
    : public grammar< RigidBodyParser, result_closure< DummyRigidBody >::context_t >
{
  public:
    template< typename ScannerT > struct definition
    {
      public:
        ...
        {
            rigidbody_r =
                eps_p[var (_rigid) = construct_< DummyRigidBody > ()] >>
                XMLAttElem_p ("RigidBody",
                              !(XMLAtt_p ("refframe", attrstr_p[var (_rigid._refframe) = arg1])),
                              *(transform3d_p[var (_rigid._transform) = arg1] |
                                XMLElem_p ("Mass", real_p[var (_rigid._mass) = arg1]) |
                                inertiamatrix_r))[self.result_ = var (_rigid)];

            inertiamatrix_r = XMLElem_p ("InertiaMatrix",
                                         real_p >> real_p >> real_p >> real_p >> real_p >> real_p >>
                                             real_p >> real_p >> real_p) |
                              (XMLElem_p ("LambdaX", real_p) >> XMLElem_p ("LambdaY", real_p) >>
  ...
  public:
    ...
    template< typename ScannerT > struct definition
    {
      public:
        ...
        {
            frame_r =
                eps_p[var (_frame) = construct_< DummyFrame > ()] >>
                XMLAttElem_p (
                    "Frame",
                    XMLAtt_p ("name", attrstr_p[var (_frame._name) = arg1]) >>
                    ...
                    // parse transform
                    !(transform3d_p[var (_frame._transform) = arg1]) >>
                        // parse properties
                        *(property_p[push_back_a (_frame._properties)] |
                          model_p[push_back_a (_frame._models)]))[self.result_ = var (_frame)];
        }
  ...
  public:
    template< typename ScannerT > struct definition
    {
      private:
        ...
        rule< ScannerT > device_r, serialdevice_r, paralleldevice_r, treedevice_r, joint_r,
            dhjoint_r, depend_r, devicebody_r, chainbody_r, serialchain_r, jointstate_r,
            mobiledevice_r, configuration_r, junction_r;
      ...
      public:
        ...
        definition (XMLDeviceParser const& self) : model_p (_scope), frame_p (_scope)
        {
            device_r = eps_p[var (_dev._scope) = _scope] >>
                       (serialdevice_r | paralleldevice_r | treedevice_r |
                        mobiledevice_r)[self.result_ = var (_dev)];

            serialchain_r = XMLAttElem_p ("SerialChain",
                                          XMLAtt_p ("name", attrstr_p[EnterScope (_scope)]),
                                          chainbody_r)[LeaveScope (_scope)];

            chainbody_r =
                *(frame_p[AddFrameToDevice (_frame, _dev, _scope)] |
                  joint_r[AddFrameToDevice (_frame, _dev, _scope)] |
                  dhjoint_r[AddFrameToDevice (_frame, _dev, _scope)] |
                  model_p[InsertModelInMap (_model, _model._refframe, _scope, _dev._modelMap)] |
                  jointlimit_r[InsertLimitInMap (_scope, _dev._limitMap)] |
                  property_p[InsertPropertyInMap (_scope, _dev._propertyMap)] | serialchain_r |
                  colsetup_r[push_back_a (_dev._colsetups)] |
                  proxsetup_r[push_back_a (_dev._proxsetups)]);

            colsetup_r = XMLAttElem_p (
                "CollisionSetup",
                XMLAtt_p (
                    "file",
                    attrstr_p[var (_setup._filename) = arg1][var (_setup._scope) = var (_scope)] >>
                        filepos_p[var (_setup._pos) = arg1]),
                eps_p)[colsetup_r.result_ = var (_setup)];

            /*calibration_r =
                            XMLAttElem_p("Calibration",
                                            XMLAtt_p("file", attrstr_p[ var(_calibration._filename)
               = arg1 ] [ var( _calibration._scope ) = var( _scope ) ] >> filepos_p[
               var(_calibration._pos) = arg1 ]
                              ),
                              eps_p
                          )[ calibration_r.result_ = var(_calibration) ];

                            */
            proxsetup_r = XMLAttElem_p ("ProximitySetup",
                                        XMLAtt_p ("file",
                                                  attrstr_p[var (_psetup._filename) = arg1]
                                                           [var (_psetup._scope) = var (_scope)] >>
                                                      filepos_p[var (_psetup._pos) = arg1]),
                                        eps_p)[proxsetup_r.result_ = var (_psetup)];

            devicebody_r = chainbody_r >>
            ...
            configuration_r = XMLAttElem_p ("Q",
                                            XMLAtt_p ("name", attrstr_p[var (_config.name) = arg1]),
                                            *real_p[push_back_a (_config.q)]);

            junction_r = XMLElem_p (
                "Junction",
                *XMLElem_p (
                    "Chains",
                    (*(anychar_p - (str_p ("</") >> "Chains")))[push_back_a (_junction.chains)]

                    ));

            treedevice_r =
                eps_p[var (_dev) = construct_< DummyDevice > ()] >>
                XMLAttElem_p (
                    "TreeDevice",
                    XMLAtt_p ("name",
                              attrstr_p[var (_dev._name) = arg1][var (_dev._type) = TreeType]
                                       [EnterScope (_scope)]),
                    devicebody_r)[LeaveScope (_scope)];
            ...
            serialdevice_r =
                ...
                XMLAttElem_p (
                    "SerialDevice",
                    XMLAtt_p ("name",
                              attrstr_p[var (_dev._name) = arg1][var (_dev._type) = SerialType]
                                       [EnterScope (_scope)]),
                    devicebody_r)[LeaveScope (_scope)];
            ...
            paralleldevice_r =
                ...
                XMLAttElem_p (
                    "ParallelDevice",
                    XMLAtt_p ("name",
                              attrstr_p[var (_dev._name) = arg1][var (_dev._type) = ParallelType]
                                       [EnterScope (_scope)]),
                    chainbody_r >> (*junction_r[AddJunctionToDevice (_junction, _dev)]
                                               [var (_junction) = var (emptyJunction)]) >>
                        (*configuration_r[AddConfigToDevice (_config, _dev)]
                                         [var (_config) = var (emptyConfig)]))[LeaveScope (_scope)];
            ...
            mobiledevice_r =
                ...
                XMLAttElem_p (
                    "MobileDevice",
                    XMLAtt_p ("name",
                              attrstr_p[var (_dev._name) = arg1][var (_dev._type) = MobileType]
                                       [EnterScope (_scope)]) >>
                        XMLAtt_p ("basename", attrstr_p[var (_dev._basename) = arg1]),
            ...
            /*
                            ...
                            conveyorsegment_r =
                                ...
                                ;
              */
            jointstate_r = (str_p ("Active")[var (_frame._state) = ActiveState] |
...
+       return Transform3D<T>::DH(alpha, a, d, theta);
            ...
            dhjoint_r =
                eps_p[var (_frame) = construct_< DummyFrame > ()] >>    // init _frame
                XMLAttElem_p (
                    "DHJoint",
                    (XMLAtt_p ("name", attrstr_p[var (_frame._name) = arg1]) >>
                     XMLAtt_p ("alpha", real_p[var (_dhparam._alpha) = arg1 * Deg2Rad]) >>
                     XMLAtt_p ("a", real_p[var (_dhparam._a) = arg1]) >>
                     ((XMLAtt_p (
                           "d",
                           real_p[var (_dhparam._dhtype) = Revolute]
                                 [var (_frame._type) = "Revolute"][var (_dhparam._d) = arg1]) >>
                       XMLAtt_p ("offset", real_p[var (_dhparam._offset) = arg1 * Deg2Rad])) |
                      (XMLAtt_p ("theta",
                                 real_p[var (_dhparam._dhtype) = Prismatic]
                                       [var (_frame._type) = "Prismatic"]
                                       [var (_dhparam._theta) = arg1 * Deg2Rad]) >>
                       (XMLAtt_p ("offset", real_p[var (_dhparam._offset) = arg1]))) |
                      (XMLAtt_p ("beta",
                                 real_p[var (_dhparam._dhtype) = Prismatic]
                                       [var (_frame._type) = "Prismatic"]
                     ...
                     !(XMLAtt_p ("state", jointstate_r)) >>
                     !(XMLAtt_p ("type", attrstr_p[var (_dhparam._type) = arg1])))[SetTransform3D (
                        _dhparam, _frame._transform)][SetDHParam (_dhparam, _frame)],

                    *(jointlimit_r[push_back_a (_frame._limits)] | depend_r |
                      property_p[push_back_a (_frame._properties)] |
                      model_p[push_back_a (_frame._models)]));

            depend_r = XMLAttElem_p ("Depend",
                                     ...
                                     eps_p)[var (_frame._isDepend) = true];

            jointlimit_r =
                eps_p[var (_limit) = construct_< DummyLimit > ()] >>
                (XMLAttElem_p (
                     "PosLimit",
                     !(XMLAtt_p ("refjoint", attrstr_p[var (_limit._refjoint) = arg1])) >>
                             (XMLAtt_p ("min", real_p[var (_limit._min) = arg1]) >>
                              XMLAtt_p ("max",
                                        real_p[var (_limit._max) = arg1]
                                              [var (_limit._type) = PosLimitType])) |
                         (XMLAtt_p ("max", real_p[var (_limit._max) = arg1]) >>
                          XMLAtt_p (
                              "min",
                              real_p[var (_limit._min) = arg1][var (_limit._type) = PosLimitType])),
                     eps_p) |
                 XMLAttElem_p (
                     "VelLimit",
                     !(XMLAtt_p ("refjoint", attrstr_p[var (_limit._refjoint) = arg1])) >>
                         XMLAtt_p (
                             "max",
                             real_p[var (_limit._max) = arg1][var (_limit._type) = VelLimitType]),
                     eps_p) |
                 XMLAttElem_p (
                     "AccLimit",
                     !(XMLAtt_p ("refjoint", attrstr_p[var (_limit._refjoint) = arg1])) >>
                         XMLAtt_p (
                             "max",
                             real_p[var (_limit._max) = arg1][var (_limit._type) = AccLimitType]),
                     eps_p))[jointlimit_r.result_ = var (_limit)];
        }
    };
};

struct XMLWorkcellParser
    : public grammar< XMLWorkcellParser, result_closure< DummyWorkcell >::context_t >
{
  public:
    template< typename ScannerT > struct definition
    {
      ...
      public:
        ...
        {
            guardwrapper_r = XMLErrorHandler::XMLErrorGuard (workcelldev_r)[XMLErrorHandler ()];

            workcelldev_r = (wc_r | device_p[AddDeviceToWorkcell (_wc, _scope)]) >>
                            end_p[self.result_ = var (_wc)];

            wc_r = XMLAttElem_p ("WorkCell",
                                 XMLAtt_p ("name", attrstr_p[var (_wc._name) = arg1]),
                                 *(device_p[AddDeviceToWorkcell (_wc, _scope)] |
                                   frame_p[AddFrameToWorkcell (_wc, _scope)] |
                                   model_p[push_back_a (_wc._models)] | camera_r |
            ...
            camera_r = XMLAttElem_p ("Camera", XMLAtt_p ("name", attrstr_p), !transform3d_p);
            calibration_r =
                XMLAttElem_p ("Calibration",
                              XMLAtt_p ("file",
                                        attrstr_p[var (_calibration._filename) = arg1]
                                                 [var (_calibration._scope) = var (_scope)] >>
                                            filepos_p[var (_calibration._pos) = arg1]),
                              eps_p)[calibration_r.result_ = var (_calibration)];
        }
    };
};
}    // end of namespace

...
namespace rw { namespace geometry {
     ...
     */
    template< class T = double > class Triangle
    {
      private:
      ...
      public:
         ...
         */
        rw::math::Vector3D< T >& getVertex (size_t i) { return _vertices[i]; }
     ...
     * with the facenormal.
     */
    template< class T = double > class TriangleN1
    {
      private:
        Triangle< T > _triN0;
      ...
      public:
         ...
         */
        TriangleN1 (const rw::math::Vector3D< T >& p1, const rw::math::Vector3D< T >& p2,
                    const rw::math::Vector3D< T >& p3) :
            _triN0 (p1, p2, p3),
         ...
         */
        TriangleN1 (const rw::math::Vector3D< T >& p1, const rw::math::Vector3D< T >& p2,
                    const rw::math::Vector3D< T >& p3, const rw::math::Vector3D< T >& n) :
            _triN0 (p1, p2, p3),
            _faceNormal (n)
        {}
        ...
        TriangleN1 (const Triangle< T >& t, const rw::math::Vector3D< T >& n) :
            _triN0 (t), _faceNormal (n)
        {}

        /**
         * @brief constructor
         */
        TriangleN1 (const Triangle< T >& t) : _triN0 (t), _faceNormal (t.calcFaceNormal ()) {}
         ...
         */
        rw::math::Vector3D< T >& getFaceNormal () { return _faceNormal; }

        /**
         * @brief returns the facenormal of this triangle
         */
        const rw::math::Vector3D< T >& getFaceNormal () const { return _faceNormal; }
     ...
     */
    template< class T = double > class TriangleN3
    {
      private:
        Triangle< T > _triN0;
      ...
      public:
        ...
        /**
         * @brief constructor, with all input defined
         */
        TriangleN3 (const rw::math::Vector3D< T >& p1, const rw::math::Vector3D< T >& p2,
                    const rw::math::Vector3D< T >& p3, const rw::math::Vector3D< T >& n1,
                    const rw::math::Vector3D< T >& n2, const rw::math::Vector3D< T >& n3) :
            _triN0 (p1, p2, p3)
        {
            _vertexNormals[0] = n1;
            _vertexNormals[1] = n2;
        ...
        /**
         * @brief constructor from triangle and normals
         */
        TriangleN3 (const Triangle< T >& t, const rw::math::Vector3D< T >& n1,
                    const rw::math::Vector3D< T >& n2, const rw::math::Vector3D< T >& n3) :
            _triN0 (t)
        {
            _vertexNormals[0] = n1;
         ...
         */
        rw::math::Vector3D< T >& getNormal (size_t i) { return _vertexNormals[i]; }

        /**
         * @brief return vertex normal of the vertex specified by i
         */
        const rw::math::Vector3D< T >& getNormal (size_t i) const { return _vertexNormals[i]; }
        ...
        {
            return TriangleN3< T > (_triN0.transform (t3d),
                                    t3d.R () * _vertexNormals[0],
                                    t3d.R () * _vertexNormals[1],

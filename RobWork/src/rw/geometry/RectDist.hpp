...
void closestPointsBetweenTwoEdges (const Vector& endpoint1OfEdge1, const Vector& endpoint2OfEdge1,
                                   const Vector& endpoint1OfEdge2, const Vector& endpoint2OfEdge2,
                                   Vector& closestPointOnEdge1, Vector& closestPointOnEdge2)
{
...
bool isInVoronoiRegion (const Vector& endpointOfEdge, const Vector& thirdPointOnRectangle,
...
double distanceBetweenRectangles2 (const Rotation& rotation, const Vector& position,
                                   double size[2][2])
{
    ...
    for (int i = 0; i < 4; i++) {
        for (int j = 0; j < 4; j++) {
            if ((isInVoronoiRegion (rectangle1Corners[(i + 1) % 4],
                                    rectangle1Corners[(i + 2) % 4],
                                    rectangle2Corners[j]) ||
                 isInVoronoiRegion (rectangle1Corners[(i + 1) % 4],
                                    rectangle1Corners[(i + 2) % 4],
                                    rectangle2Corners[(j + 1) % 4])) &&
                (isInVoronoiRegion (rectangle2Corners[(j + 1) % 4],
                                    rectangle2Corners[(j + 2) % 4],
                                    rectangle1Corners[i]) ||
                 isInVoronoiRegion (rectangle2Corners[(j + 1) % 4],
                                    rectangle2Corners[(j + 2) % 4],
                                    rectangle1Corners[(i + 1) % 4]))) {
                closestPointsBetweenTwoEdges (rectangle1Corners[i],
                                              rectangle1Corners[(i + 1) % 4],
                                              rectangle2Corners[j],
                                              rectangle2Corners[(j + 1) % 4],
                                              closestPointOnEdge1,
    ...
    double z = rotation (0, 2) * position (0) + rotation (1, 2) * position (1) +
    ...
    if (position[2] > 0.0) {
        ...
        if (rotation (2, 0) < 0.0)
            separation1 += size[1][0] * rotation (2, 0);
        if (rotation (2, 1) < 0.0)
            separation1 += size[1][1] * rotation (2, 1);
    }
    else {
        separation1 = -position[2];
        if (rotation (2, 0) > 0.0)
    ...
    if (z < 0) {
        separation2 = -z;
        if (rotation (0, 2) < 0.0)
            separation2 += size[0][0] * rotation (0, 2);
        if (rotation (1, 2) < 0.0)
            separation2 += size[0][1] * rotation (1, 2);
    }
    else {
        separation2 = z;
        if (rotation (0, 2) > 0.0)
...
double distanceBetweenRectangles3 (const Rotation& R, const Vector& p, double r[2][2])
{
    ...
    else if ((R2dotP > 0 || R2dotP > r[0][0] * R (0, 1)) &&
             (p (1) < 0 || r[1][0] * R (1, 0) + p (1) < 0)) {
        // calc closest points
        // check: is closest point in voronoi
        den = 1 - R (0, 0) * R (0, 0);
    ...
    if (R2dotP + r[1][1] < 0 && R2dotP + r[1][1] < R (0, 1) * r[0][0]) {
        ...
        if (p (1) + r[1][0] * R (1, 0) + r[1][1] * R (1, 1) < 0 && p (1) + r[1][1] * R (1, 1) < 0) {
            ...
            v = Vector (p (0) + R (0, 0) * t + R (0, 1) * r[1][1] - s,
        ...
        else if (p (1) + r[1][0] * R (1, 0) + r[1][1] * R (1, 1) < 0 ||
                 p (1) + r[1][1] * R (1, 1) < 0) {
            den = 1 - R (0, 0) * R (0, 0);
    ...
    else if ((R2dotP + r[1][1] < 0 || R2dotP + r[1][1] < R (0, 1) * r[0][0]) &&
             (p (1) + r[1][0] * R (1, 0) + r[1][1] * R (1, 1) < 0 ||
              p (1) + r[1][1] * R (1, 1) < 0)) {
        den = 1 - R (0, 0) * R (0, 0);
    ...
    if (R2dotP > r[0][0] * R (0, 1) + r[0][1] * R (1, 1) && R2dotP > r[0][1] * R (1, 1)) {
        ...
        if (p (1) > r[0][1] && p (1) + R (1, 0) * r[1][0] > r[0][1]) {
            ...
            v = Vector (
                p (0) + R (0, 0) * t - s, p (1) + R (1, 0) * t - r[0][1], p (2) + R (2, 0) * t);
    ...
    else if ((R2dotP > r[0][0] * R (0, 1) + r[0][1] * R (1, 1) || R2dotP > r[0][1] * R (1, 1)) &&
    ...
    if (r[0][0] * R (0, 1) + r[0][1] * R (1, 1) - r[1][1] > R2dotP &&
        r[0][1] * R (1, 1) - r[1][1] > R2dotP) {
        // B3 and B4 in Voronoi of eA3
        if (p (1) + r[1][1] * R (1, 1) + r[1][0] * R (1, 0) > r[0][1] &&
            p (1) + r[1][1] * R (1, 1) > r[0][1]) {
            den = 1 - R (0, 0) * R (0, 0);
            ...
            v = Vector (p (0) + R (0, 1) * r[1][1] + R (0, 0) * t - s,
        ...
        else if (p (1) + r[1][1] * R (1, 1) + r[1][0] * R (1, 0) > r[0][1] ||
                 p (1) + r[1][1] * R (1, 1) > r[0][1]) {
            den = 1 - R (0, 0) * R (0, 0);
    ...
    // Either A3 or A4 is in Voronoi of eB1 AND either B1 or B2 is in Voronoi of eA3
    else if ((r[0][0] * R (0, 1) + r[0][1] * R (1, 1) - r[1][1] > R2dotP ||
              r[0][1] * R (1, 1) - r[1][1] > R2dotP) &&
             (p (1) + r[1][1] * R (1, 1) + r[1][0] * R (1, 0) > r[0][1] ||
              p (1) + r[1][1] * R (1, 1) > r[0][1])) {
        den = 1 - R (0, 0) * R (0, 0);
        ...
        if (p (1) + R (1, 1) * r[1][1] + R (1, 0) * t > r[0][1] &&
            s * R (0, 1) + r[0][1] * R (1, 1) - r[1][1] > R2dotP) {
            v = Vector (p (0) + R (0, 1) * r[1][1] + R (0, 0) * t - s,
                        p (1) + R (1, 1) * r[1][1] + R (1, 0) * t - r[0][1],
                        p (2) + R (2, 1) * r[1][1] + R (2, 0) * t);
    ...
    if (R1dotP > 0 && R1dotP > r[0][1] * R (1, 0)) {
        ...
        if (p (0) < 0 && p (0) + R (0, 1) * r[1][1] < 0) {
            ...
            v = Vector (p (0) + R (0, 1) * t, p (1) + R (1, 1) * t - s, p (2) + R (2, 1) * t);
    ...
    if (p (0) + R (0, 0) * r[1][0] < 0 && p (0) + R (0, 1) * r[1][1] + R (0, 0) * r[1][0] < 0) {
        ...
        if (R1dotP + r[1][0] < 0 && R1dotP + r[1][0] < r[0][1] * R (1, 0)) {
            ...
            v = Vector (p (0) + R (0, 0) * r[1][0] + R (0, 1) * t,
    ...
    else if ((p (0) + R (0, 0) * r[1][0] < 0 ||
              p (0) + R (0, 1) * r[1][1] + R (0, 0) * r[1][0] < 0) &&
    ...
    if (R1dotP > R (0, 0) * r[0][0] && r[0][0] * R (0, 0) + r[0][1] * R (1, 0) < R1dotP) {
        ...
        if (p (0) > r[0][0] && p (0) + R (0, 1) * r[1][1] > r[0][0]) {
            ...
            v = Vector (
                p (0) + R (0, 1) * t - r[0][0], p (1) + R (1, 1) * t - s, p (2) + R (2, 1) * t);
    ...
    else if ((R1dotP > R (0, 0) * r[0][0] || r[0][0] * R (0, 0) + r[0][1] * R (1, 0) < R1dotP) &&
    ...
    if (r[0][0] * R (0, 0) > R1dotP + r[1][0] &&
        r[0][0] * R (0, 0) + r[0][1] * R (1, 0) > R1dotP + r[1][0]) {
        // B2 and B3 in Voronoi of eA2
        if (p (0) + r[1][0] * R (0, 0) > r[0][0] &&
            p (0) + r[1][0] * R (0, 0) + r[1][1] * R (0, 1) > r[0][0]) {
            den = 1 - R (1, 1) * R (1, 1);
            ...
            v = Vector (p (0) + R (0, 0) * r[1][0] + R (0, 1) * t - r[0][0],
                        p (1) + R (1, 0) * r[1][0] + R (1, 1) * t - s,
                        p (2) + R (2, 0) * r[1][0] + R (2, 1) * t);

            return sqrt (dot (v, v));
        }
        else if (p (0) + r[1][0] * R (0, 0) > r[0][0] ||
                 p (0) + r[1][0] * R (0, 0) + r[1][1] * R (0, 1) > r[0][0]) {
            den = 1 - R (1, 1) * R (1, 1);
    ...
    else if ((r[0][0] * R (0, 0) > R1dotP + r[1][0] ||
              r[0][0] * R (0, 0) + r[0][1] * R (1, 0) > R1dotP + r[1][0]) &&
             (p (0) + r[1][0] * R (0, 0) > r[0][0] ||
              p (0) + r[1][0] * R (0, 0) + r[1][1] * R (0, 1) > r[0][0])) {
        den = 1 - R (1, 1) * R (1, 1);
        ...
        if (p (0) + R (0, 0) * r[1][0] + R (0, 1) * t > r[0][0] &&
            r[0][0] * R (0, 0) + s * R (1, 0) > R1dotP + r[1][0]) {
            v = Vector (p (0) + R (0, 0) * r[1][0] + R (0, 1) * t - r[0][0],
                        p (1) + R (1, 0) * r[1][0] + R (1, 1) * t - s,
                        p (2) + R (2, 0) * r[1][0] + R (2, 1) * t);
    ...
    if (R1dotP > 0 && R1dotP > r[0][0] * R (0, 0)) {
        ...
        if (p (1) < 0 && p (1) + R (1, 1) * r[1][1] < 0) {
            ...
            v = Vector (p (0) + R (0, 1) * t - s, p (1) + R (1, 1) * t, p (2) + R (2, 1) * t);
    ...
    if (R1dotP + r[1][0] < 0 && R1dotP + r[1][0] < r[0][0] * R (0, 0)) {
        if (p (1) + r[1][0] * R (1, 0) < 0 && p (1) + r[1][0] * R (1, 0) + r[1][1] * R (1, 1) < 0) {
            ...
            v = Vector (p (0) + R (0, 0) * r[1][0] + R (0, 1) * t - s,
                        p (1) + R (1, 0) * r[1][0] + R (1, 1) * t,
                        p (2) + R (2, 0) * r[1][0] + R (2, 1) * t);

            return sqrt (dot (v, v));
        }
        else if (p (1) + r[1][0] * R (1, 0) < 0 ||
                 p (1) + r[1][0] * R (1, 0) + r[1][1] * R (1, 1) < 0) {
            den = 1 - R (0, 1) * R (0, 1);
    ...
    else if ((R1dotP + r[1][0] < 0 || R1dotP + r[1][0] < r[0][0] * R (0, 0)) &&
             (p (1) + r[1][0] * R (1, 0) < 0 ||
              p (1) + r[1][0] * R (1, 0) + r[1][1] * R (1, 1) < 0)) {
        den = 1 - R (0, 1) * R (0, 1);
    ...
    if (R2dotP > 0 && R2dotP > r[0][1] * R (1, 1)) {
        ...
        if (p (0) < 0 && p (0) + R (0, 0) * r[1][0] < 0) {
            ...
            v = Vector (p (0) + R (0, 0) * t, p (1) + R (1, 0) * t - s, p (2) + R (2, 0) * t);
    ...
    if (R2dotP + r[1][1] < 0 && r[0][1] * R (1, 1) > R2dotP + r[1][1]) {
        ...
        if (p (0) + R (0, 1) * r[1][1] < 0 && p (0) + R (0, 1) * r[1][1] + R (0, 0) * r[1][0] < 0) {
            ...
            v = Vector (p (0) + R (0, 1) * r[1][1] + R (0, 0) * t,
                        p (1) + R (1, 1) * r[1][1] + R (1, 0) * t - s,
                        p (2) + R (2, 1) * r[1][1] + R (2, 0) * t);

            return sqrt (dot (v, v));
        }
        else if (p (0) + R (0, 1) * r[1][1] < 0 ||
                 p (0) + R (0, 1) * r[1][1] + R (0, 0) * r[1][0] < 0) {
            den = 1 - R (1, 0) * R (1, 0);
    ...
    else if ((R2dotP + r[1][1] < 0 || r[0][1] * R (1, 1) > R2dotP + r[1][1]) &&
             (p (0) + R (0, 1) * r[1][1] < 0 ||
              p (0) + R (0, 1) * r[1][1] + R (0, 0) * r[1][0] < 0)) {
        den = 1 - R (1, 0) * R (1, 0);
    ...
    if (R2dotP > R (0, 1) * r[0][0] && R2dotP > R (0, 1) * r[0][0] + R (1, 1) * r[0][1]) {
        ...
        if (p (0) > r[0][0] && p (0) + R (0, 0) * r[1][0] > r[0][0]) {
            ...
            v = Vector (
                p (0) + R (0, 0) * t - r[0][0], p (1) + R (1, 0) * t - s, p (2) + R (2, 0) * t);
    ...
    else if ((R2dotP > R (0, 1) * r[0][0] || R2dotP > R (0, 1) * r[0][0] + R (1, 1) * r[0][1]) &&
    ...
    // A2 and A3 in V(eB3)
    if (r[0][0] * R (0, 1) > r[1][1] + R2dotP &&
        r[0][0] * R (0, 1) + r[0][1] * R (1, 1) > r[1][1] + R2dotP) {
        // B3 and B4 in V(eA2)
        if (p (0) + R (0, 1) * r[1][1] > r[0][0] &&
            p (0) + R (0, 1) * r[1][1] + R (0, 0) * r[1][0] > r[0][0]) {
            den = 1 - R (1, 0) * R (1, 0);
            ...
            v = Vector (p (0) + R (0, 1) * r[1][1] + R (0, 0) * t - r[0][0],
                        p (1) + R (1, 1) * r[1][1] + R (1, 0) * t - s,
                        p (2) + R (2, 1) * r[1][1] + R (2, 0) * t);

            return sqrt (dot (v, v));
        }
        else if (p (0) + R (0, 1) * r[1][1] > r[0][0] ||
                 p (0) + R (0, 1) * r[1][1] + R (0, 0) * r[1][0] > r[0][0]) {
            den = 1 - R (1, 0) * R (1, 0);
    ...
    else if ((r[0][0] * R (0, 1) > r[1][1] + R2dotP ||
              r[0][0] * R (0, 1) + r[0][1] * R (1, 1) > r[1][1] + R2dotP) &&
             (p (0) + R (0, 1) * r[1][1] > r[0][0] ||
              p (0) + R (0, 1) * r[1][1] + R (0, 0) * r[1][0] > r[0][0])
        ...
        if (p (0) + R (0, 1) * r[1][1] + R (0, 0) * t > r[0][0] &&
            r[0][0] * R (0, 1) + s * R (1, 1) > r[1][1] + R2dotP) {
            v = Vector (p (0) + R (0, 1) * r[1][1] + R (0, 0) * t - r[0][0],
                        p (1) + R (1, 1) * r[1][1] + R (1, 0) * t - s,
                        p (2) + R (2, 1) * r[1][1] + R (2, 0) * t);
    ...
    if (R1dotP > r[0][1] * R (1, 0) && R1dotP > r[0][1] * R (1, 0) + r[0][0] * R (0, 0)) {
        ...
        if (p (1) > r[0][1] && p (1) + R (1, 1) * r[1][1] > r[0][1]) {
            ...
            v = Vector (
                p (0) + R (0, 1) * t - s, p (1) + R (1, 1) * t - r[0][1], p (2) + R (2, 1) * t);
    ...
    else if ((R1dotP > r[0][1] * R (1, 0) || R1dotP > r[0][1] * R (1, 0) + r[0][0] * R (0, 0)) &&
    ...
    // A3 and A4 in V(eB2)
    if (r[0][1] * R (1, 0) > R1dotP + r[1][0] &&
        r[0][1] * R (1, 0) + r[0][0] * R (0, 0) > R1dotP + r[1][0]) {
        // B2 and B3 in V(eA3)
        if (p (1) + r[1][0] * R (1, 0) > r[0][1] &&
            p (1) + r[1][0] * R (1, 0) + r[1][1] * R (1, 1) > r[0][1]) {
            den = 1 - R (0, 1) * R (0, 1);
    ...
    else if ((r[0][1] * R (1, 0) > R1dotP + r[1][0] ||
              r[0][1] * R (1, 0) + r[0][0] * R (0, 0) > R1dotP + r[1][0]) &&
             (p (1) + r[1][0] * R (1, 0) > r[0][1] ||
              p (1) + r[1][0] * R (1, 0) + r[1][1] * R (1, 1) > r[0][1])) {
        den = 1 - R (0, 1) * R (0, 1);
        ...
        if (p (1) + r[1][0] * R (1, 0) + t * R (1, 1) > r[0][1] &&
            r[0][1] * R (1, 0) + s * R (0, 0) > R1dotP + r[1][0]) {
            v = Vector (p (0) + R (0, 0) * r[1][0] + R (0, 1) * t - s,
                        p (1) + R (1, 0) * r[1][0] + R (1, 1) * t - r[0][1],
                        p (2) + R (2, 0) * r[1][0] + R (2, 1) * t);

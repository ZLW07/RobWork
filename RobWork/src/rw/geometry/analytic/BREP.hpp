...
namespace rw { namespace geometry {
    ...
    class BREP : public rw::geometry::GeometryData
    {
      public:
        ...
        /**
         * @brief Get surface.
         * @param surfaceIndex [in] the index of the surface. Should be less than the number
         * returned by size().
        ...
        /**
         * @brief Get curve.
         * @param curveIndex [in] index of the curve. Should be less than the number returned by
         * edgeCount().
        ...
        /**
         * @brief Get vertex.
         * @param vertexIndex [in] index of the vertex. Should be less than the number returned by
         * vertices().
         ...
         * @param first [in] id of the first edge. 1-indexing is expected, with a sign that
         * indicates the edge direction.
         * @param second [in] id of the following edge. 1-indexing is expected, with a sign that
         * indicates the edge direction.
         ...
         * indicates the edge direction.
         * @param second [in] id of the second edge. 0-indexing is expected, with a sign that
         * indicates the edge direction.
         * @note Implementations calling this function should remember to delete the curve
         * associated to the second half-edge if it is different than the curve set for the first
         * half-edge.
         ...
         * be returned to indicate that the surface has unbounded minimum value in the given \b
         * direction.
         *
         * If the surface has no upper bound, the value %std::numeric_limits\<double\>::%max() can
         * be returned to indicate that the surface has unbounded maximum value in the given \b
         * direction.
         *
         * @param faceIndex [in] the face index, which should be less than loopCount().
      ...
      protected:
         ...
         *
         * In the half-edge structure, a vertex is a points that has a pointer to a neighbour
         * half-edge.
         */
        struct Vertex
        {
         ...
         * A half-edge has pointers to the previous and next vertices, previous and next edges, and
         * a face.
         */
        struct HalfEdge
        {
            ...
            //! @brief Pointer to the vertex at beginning of curve (previous and next might be the
            //! same vertex).
            const Vertex* previousVertex;
            //! @brief Pointer to the vertex at end of curve (previous and next might be the same
            //! vertex).
            const Vertex* nextVertex;
            //! @brief Pointer to the face (all half-edges forming a loop will point to the same
            //! face).
            const Face* face;
            ...
            //! @brief True if the curve is in the reverse direction. As a pair of half-edges points
            //! to the same curve data, one of the half-edges will have to be reversed.
            bool reversed;
        };
      ...
      protected:
         ...
         *
         * Notice that a curve has direction, so it should start in \b vertex1 and end in \b
         * vertex2.
         *

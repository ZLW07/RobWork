...
namespace rw { namespace geometry {
    ...
    class QuadraticUtil
    {
      public:
         ...
         *
         * The approximation is valid when the distance is small.
         * Only closest points within the trimming region of surface \b s and within the limits of
         * curve \b c will give a result.
         *
      ...
      private:
         ...
         * and \b sb and the curve \b c.
         *
         * The approximation is valid when the distance is small.
         * Only closest points within the limits of curve \b c will give a result.
         * The curve between surfaces \b sa and \b sb, is not checked with curve limits or trimming
         * region conditions.
         *
         ...
         * points to the curve between surfaces \b sa and \b sb.
         *
         * The approximation is valid when the distance is small.

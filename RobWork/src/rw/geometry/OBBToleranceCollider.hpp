...
namespace rw { namespace geometry {
    ...
    class OBBToleranceCollider
        : public BVCollider< OBBToleranceCollider< T >, rw::geometry::OBB< T > >
    {
      public:
         ...
         */
        bool collides (const rw::geometry::OBB< T >& obbA, const rw::geometry::OBB< T >& obbB,
                       const rw::math::Transform3D< T >& aTb, double tolerance);
    ...
    template< class T >
    bool OBBToleranceCollider< T >::collides (const rw::geometry::OBB< T >& obbA,
                                              ...
                                              double tolerance)
    {
        ...
        aRbf[0][0] = fabs (aRb (0, 0));
        aRbf[0][0] += reps;
        aRbf[0][1] = fabs (aRb (0, 1));
        aRbf[0][1] += reps;
        aRbf[0][2] = fabs (aRb (0, 2));
        aRbf[0][2] += reps;
        aRbf[1][0] = fabs (aRb (1, 0));
        aRbf[1][0] += reps;
        aRbf[1][1] = fabs (aRb (1, 1));
        aRbf[1][1] += reps;
        aRbf[1][2] = fabs (aRb (1, 2));
        aRbf[1][2] += reps;
        aRbf[2][0] = fabs (aRb (2, 0));
        aRbf[2][0] += reps;
        aRbf[2][1] = fabs (aRb (2, 1));
        aRbf[2][1] += reps;
        aRbf[2][2] = fabs (aRb (2, 2));
        aRbf[2][2] += reps;
        ...
        r &= (t <= (a[0] + b[0] * aRbf[0][0] + b[1] * aRbf[0][1] + b[2] * aRbf[0][2]));
        if (!r)
            return false;    // 1
        ...
        r &= (t <= (b[0] + a[0] * aRbf[0][0] + a[1] * aRbf[1][0] + a[2] * aRbf[2][0]));
        if (!r)
            return false;    // (2)
        ...
        r &= (t <= (a[1] + b[0] * aRbf[1][0] + b[1] * aRbf[1][1] + b[2] * aRbf[1][2]));
        if (!r)
            return false;    // 3;
        ...
        r &= (t <= (a[2] + b[0] * aRbf[2][0] + b[1] * aRbf[2][1] + b[2] * aRbf[2][2]));
        if (!r)
            return false;    // 4;
        ...
        r &= (t <= (b[1] + a[0] * aRbf[0][1] + a[1] * aRbf[1][1] + a[2] * aRbf[2][1]));
        if (!r)
            return false;    // 5;
        ...
        r &= (t <= (b[2] + a[0] * aRbf[0][2] + a[1] * aRbf[1][2] + a[2] * aRbf[2][2]));
        if (!r)
            return false;    // 6;
        ...
        r &= (t <= (a[1] * aRbf[2][0] + a[2] * aRbf[1][0] + b[1] * aRbf[0][2] + b[2] * aRbf[0][1]));
        if (!r)
            return false;    // 7;
        ...
        r &= (t <= (a[1] * aRbf[2][1] + a[2] * aRbf[1][1] + b[0] * aRbf[0][2] + b[2] * aRbf[0][0]));
        if (!r)
            return false;    // 8;
        ...
        r &= (t <= (a[1] * aRbf[2][2] + a[2] * aRbf[1][2] + b[0] * aRbf[0][1] + b[1] * aRbf[0][0]));
        if (!r)
            return false;    // 9;
        ...
        r &= (t <= (a[0] * aRbf[2][0] + a[2] * aRbf[0][0] + b[1] * aRbf[1][2] + b[2] * aRbf[1][1]));
        if (!r)
            return false;
        ...
        r &= (t <= (a[0] * aRbf[2][1] + a[2] * aRbf[0][1] + b[0] * aRbf[1][2] + b[2] * aRbf[1][0]));
        if (!r)
            return false;    // 11;
        ...
        r &= (t <= (a[0] * aRbf[2][2] + a[2] * aRbf[0][2] + b[0] * aRbf[1][1] + b[1] * aRbf[1][0]));
        if (!r)
            return false;    // 12;
        ...
        r &= (t <= (a[0] * aRbf[1][0] + a[1] * aRbf[0][0] + b[1] * aRbf[2][2] + b[2] * aRbf[2][1]));
        if (!r)
            return false;    // 13;
        ...
        r &= (t <= (a[0] * aRbf[1][1] + a[1] * aRbf[0][1] + b[0] * aRbf[2][2] + b[2] * aRbf[2][0]));
        if (!r)
            return false;    // 14;
        ...
        r &= (t <= (a[0] * aRbf[1][2] + a[1] * aRbf[0][2] + b[0] * aRbf[2][1] + b[1] * aRbf[2][0]));
        if (!r)
            return false;    // 15;

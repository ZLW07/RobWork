...
TriMeshSurfaceSampler::TriMeshSurfaceSampler (
    ...
    _minD (0.02),
    _maxD (0.02), _genRandomRotation (true), _filterByDirection (false), _genRandomPostion (true)
{
...
void TriMeshSurfaceSampler::setZAxisDirectionEnabled (bool enabled)
{
    _filterByDirection = enabled;
}
...
rw::geometry::TriMesh::Ptr TriMeshSurfaceSampler::getMesh ()
{
    return _meshes[0];
}

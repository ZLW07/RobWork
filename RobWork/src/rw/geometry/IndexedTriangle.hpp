...
namespace rw { namespace geometry {
    ...
    template< class T = uint16_t > class IndexedTriangle
    {
      ...
      public:
         ...
         */
        T& getVertexIdx (size_t i) { return _vertices[i]; }

        /**
         * @brief returns the index of vertex i of the triangle
         */
        const T& getVertexIdx (size_t i) const { return _vertices[i]; }
     ...
     */
    template< class T > class IndexedTriangleN1
    {
      private:
      ...
      public:
         ...
         */
        IndexedTriangleN1 (T p1, T p2, T p3, T n) : _triN0 (p1, p2, p3), _normalIdx (n){};
        ...
        IndexedTriangleN1 (const IndexedTriangleN1& f) :
            _triN0 (f._triN0), _normalIdx (f.getNormalIdx ()){};

        /**
         * @brief returns the index of vertex i of the triangle
         */
        T& getVertexIdx (size_t i) { return _triN0.getVertexIdx (i); }

        /**
         * @brief returns the index of vertex i of the triangle
         */
        const T& getVertexIdx (size_t i) const { return _triN0.getVertexIdx (i); }

        /**
         * @brief returns the index of vertex i of the triangle
         */
        T& getNormalIdx () { return _normalIdx; }

        /**
         * @brief returns the index of vertex i of the triangle
         */
        const T& getNormalIdx () const { return _normalIdx; }
     ...
     * the triangle
     */
    template< class T > class IndexedTriangleN3
    {
      private:
        IndexedTriangle< T > _triN0;
        T _normals[3];
      ...
      public:
         ...
         */
        IndexedTriangleN3 (T p1, T p2, T p3, T n1, T n2, T n3) : _triN0 (p1, p2, p3)
        {
            _normals[0] = n1;
            _normals[1] = n2;
            _normals[2] = n3;
         ...
         * @param f [in] - The face that is to be copied.
         */
        IndexedTriangleN3 (const IndexedTriangleN3& f) : _triN0 (f._triN0)
        {
         ...
         * @brief returns the index of vertex i of the triangle
         */
        const T& getNormalIdx (size_t i) const { return _triN0.getVertexIdx (i); }

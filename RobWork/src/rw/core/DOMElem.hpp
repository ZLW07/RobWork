...
namespace rw { namespace core {
    ...
    class DOMElem
    {
      ...
      public:
        //! smart pointer type
        typedef rw::core::Ptr< DOMElem > Ptr;

        // forward declaration
        class Iterator;

        //! DOMElem Iterator Pair type
        typedef rw::core::iter_pair< class Iterator > IteratorPair;
        ...
        getValueAsStringList (char stringseperator = ';') const = 0;
         ...
         * @param optional [in]
         * @return the DOMElem child if found, else either NULL (is optional) or an exception is
         * thrown.
         */
         ...
         * @param optional [in]
         * @return the DOMElem attribute if found, else either NULL (is optional) or an exception is
         * thrown.
         */
        ...
        {
            return getAttribute (name)->getValueAsInt ();
        }
        /**
        ...
        {
            return getAttribute (name)->getValueAsDouble ();
        }
        /**
        ...
        // now comes the construction stuff.. so this should enable one to add elements and
        // attributes
        /**
         * @brief Add a child with an empty name.
         * @return pointer to the new child element.
         */
        virtual rw::core::Ptr< DOMElem > addChild () { return addChild (""); }
      ...
      public:
        ...
        class Iterator
        {
          ...
          public:
            ...
            /** Value type. */
            typedef rw::core::Ptr< DOMElem > value_type;

            /** Pointer type. */
            typedef rw::core::Ptr< DOMElem > pointer;

            /** Reference type. */
            typedef rw::core::Ptr< DOMElem > reference;

...
namespace rw { namespace core {
    ...
    class BoostXMLParser : public DOMParser
    {
      public:
         ...
         *
         * If the BoostXMLParser is used outside main (as a part of global
         * initialization/destruction), the BoostInitializer should be used explicitly to control
         * the static initialization/destruction order.
         *
         * Notice that the BoostInitializer is automatically defined as a global variable, hence it
         * should not be necessary to specify the initializer explicitly if BoostXMLParser is to be
      ...
      private:
        ...
        bool _debug;
        DOMElem::Ptr _root;
        rw::core::Ptr< boost::property_tree::ptree > _tree;
    };
    ...
    class BoostDOMElem : public DOMElem
    {
      public:
         ...
         */
        BoostDOMElem (const std::string& key, rw::core::Ptr< boost::property_tree::ptree > ptree,
                      rw::core::Ptr< boost::property_tree::ptree > parent,
                      rw::core::Ptr< boost::property_tree::ptree > root, BoostXMLParser* parser) :
            _name (key),
            _node (ptree), _parent (parent), _root (root), _parser (parser)
        {}
      ...
      public:
         ...
         */
        rw::core::Ptr< boost::property_tree::ptree > getRoot () { return _root; }
      ...
      private:
        std::string _name;
        rw::core::Ptr< boost::property_tree::ptree > _node;
        rw::core::Ptr< boost::property_tree::ptree > _parent;
        rw::core::Ptr< boost::property_tree::ptree > _root;

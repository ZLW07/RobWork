...
TEST(LogTestSuite, LogTest) {
     ...
     */
    {
        ...
        EXPECT_EQ(std::string(msg) , "MessageA");
        instream.getline(msg, 100);
        EXPECT_EQ(std::string(msg) , "MessageB");

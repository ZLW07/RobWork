...
Transform3D<> moveToColllision (MovableFrame* mframe, const Transform3D<>& nstep,
                                CollisionDetector::Ptr coldect, State& state)
{
...
Transform3D<> BodyUtil::placeBody (rwsim::dynamics::Body::Ptr body, CollisionDetector::Ptr coldect,
...
Body::Ptr BodyUtil::getParentBody (rwsim::dynamics::Body::Ptr child,

...
namespace rwsim { namespace dynamics {
    ...
    {
      public:
        RigidJoint (const BodyInfo& info, rw::models::Joint* joint, rw::models::Object::Ptr obj,
      ...
      public:
        int getBodyType () const { return _bodyType; };
         ...
         */
        inline double getInvMass () const { return _massInv; }
         ...
         * parent frame.
         */
        const rw::math::InertiaMatrix<>& getInertiaTensorInv () const { return _IInv; }
        ...
        rw::models::Joint* getJoint () { return _joint; }

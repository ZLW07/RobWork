...
namespace rwsimlibs { namespace gui {
    ...
    class ContactSetWidget : public SimulatorLogEntryWidget
    {
      ...
      public:
         ...
         */
        ContactSetWidget (rw::core::Ptr< const rwsim::log::LogContactSet > entry,
                          QWidget* parent = 0);
      ...
      private:
        ...
        std::list< rw::core::Ptr< rwsim::contacts::RenderContacts > > _contactRenders;
    };
    //! @}

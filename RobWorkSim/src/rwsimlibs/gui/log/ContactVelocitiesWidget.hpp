...
namespace rwsimlibs { namespace gui {
    ...
    class ContactVelocitiesWidget : public SimulatorLogEntryWidget
    {
      ...
      public:
         ...
         */
        ContactVelocitiesWidget (rw::core::Ptr< const rwsim::log::LogContactVelocities > entry,
                                 QWidget* parent = 0);
      ...
      private slots:
        void contactSetPairsChanged (const QItemSelection& newSelection,
      ...
      private:
        ...
        QString toQString (const rwsim::contacts::Contact& contact,
                           const rw::math::Vector3D<>& velA, const rw::math::Vector3D<>& velB);

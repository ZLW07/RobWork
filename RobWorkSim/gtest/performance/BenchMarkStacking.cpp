...
//TODO(TNT) C++ exception with description "Id[-1]ODESimulator.cpp:680 : Too Large Penetrations!" thrown in the test body.
/*TEST(BenchMarkStacking, ODESingleObjectStabilityTest )
{
    // add loading tests here
    ...
    std::ofstream myfile;
    myfile.open("BenchMarkStacking-ODESingleObjectStabilityTest.txt");

...
TEST(TactileArraySensorTest, TactileArraySensor)
{
    ...
    DynamicWorkCell::Ptr dwc = DynamicWorkCellLoader::load( TestEnvironment::testfilesDir() + "/scene/sensors/single_object_tactile_array.dwc.xml" );
